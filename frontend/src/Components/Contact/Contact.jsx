...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "2820fcd6-8f0c-4006-bb76-f8f88476d181"); //change the api key for different change gmail account
  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                <li><img src={mail_icon} alt="" />sagadic@ucoe.dev</li>
                <li><img src={phone_icon} alt="" />+91 123-456-7890</li>
                <li><img src={location_icon} alt="" />69 Massachusetts Ave, Somewhere<br/>Kaman Road, 401201</li>
            </ul>
        </div>
        <div className="contact-col">
